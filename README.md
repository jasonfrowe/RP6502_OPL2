...
## 🚀 Key Features
- **FPGA-Side FIFO:** A 512-entry hardware buffer handles the OPL2's strict timing requirements (3.3µs and 23µs recovery times).
...
3. **External Filter:** RC low-pass filter (1kΩ / 0.1µF) on Pin 14 (H9).
