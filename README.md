...
- The `VGMplayback` branch is for playback of VGM files generated by Furnace.  vgm2pix.py is used for conversion, which produces a raw command stream that is sent to the OPL2.  This will eventually be the primary route for music production and playback.  
